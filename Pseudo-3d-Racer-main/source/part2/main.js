...
class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.input.keyboard.on("keydown-P", () => {
      // Closure: Arrow function to capture the 'this' context of MainScene
...
class PauseScene extends Phaser.Scene {
  ...
  create() {
    // Scope: PauseScene scope

    // listener to resume game
    this.input.keyboard.on("keydown-P", () => {
      // Closure: Arrow function to capture the 'this' context of PauseScene
